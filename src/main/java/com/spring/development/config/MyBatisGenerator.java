...
//        gc.setEnableCache(true);        // 开启二级缓存
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/development?useUnicode=true&characterEncoding=UTF-8&zeroDateTimeBehavior=convertToNull&serverTimezone=Asia/Shanghai&useSSL=false");
        ...
        pc.setParent("com.spring.development.module");
